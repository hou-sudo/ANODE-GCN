...
def get_parser():
    ...
    parser.add_argument('--datacase', default='ucla', help='data loader will be used')
    ...
    parser.add_argument('--num_epoch', type=int, default=70, help='stop training in which epoch')
    ...
    parser.add_argument('--lambda_3', type=float, default=1e-3)
    ...
    parser.add_argument('--asc_dim_trans', type=int, default=10, help='')
