...
from model.modules import SC_GC, GCN


class SCGC_LSTM_Cell(nn.Module):
    def __init__(self, input_dim, hidden_dim, A):
        ...
        """
        super(SCGC_LSTM_Cell, self).__init__()

        self.input_dim  = input_dim
        self.hidden_dim = hidden_dim

        self.sagc = SC_GC(input_dim + hidden_dim, 4 * hidden_dim, A)
