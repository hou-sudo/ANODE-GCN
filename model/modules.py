...
class SC_GC(nn.Module):
    def __init__(self, in_channels, out_channels, A, seq_len):
        super(SC_GC, self).__init__()
        ...
        self.ca_attn = CA_Block(channel=out_channels, h=seq_len, w=A.shape[-1])
...
class Attention(nn.Module):
    def __init__(self, dim, seq_len, heads=8, dim_head=64, dropout=0.,
        ...
        self.to_qkv = SC_GC(dim, inner_dim * 3, A, seq_len) if SAGC_proj else\
